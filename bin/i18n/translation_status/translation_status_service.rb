  ...
  module TranslationStatus
    class Updater
      ...
      def update_translation_status(
        ...
        puts "update_translation_status"
        ...
        puts "normalized_keys: #{normalized_keys.inspect}"
      ...
      def insert_translation_status(redshift_client, translation_service, locales, normalized_keys, current_time)
        puts "insert normalized_keys: #{normalized_keys}"
        ...
        locales.each_with_index do |locale, i|
          ...
          normalized_keys.each do |normalized_key, values|
            ...
            #puts "normalized_key: #{normalized_key.inspect}"
            #puts "values: #{values}"
          ...
          puts translation_statuses.inspect
